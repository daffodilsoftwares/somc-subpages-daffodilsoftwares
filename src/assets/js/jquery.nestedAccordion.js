    ...
    return this.each(function() {
      ...
      $(El).each(function(){
          ...
          if ($node.find(o.next).length || $node.next(o.next).length) {
            if ($node.find('> a.arrow_trigger').length) {
              if (o.iconTrigger) {
                $node.find('> a.arrow_trigger').addClass('link');
              } else {
                $node.find('> a.arrow_trigger').addClass("trigger");
              }
            } else {
            ...
            if (o.lastChild && $node.find('> a.arrow_trigger').length) {$node.find('> a.arrow_trigger').addClass("trigger");}
          }
      });
      function nodes(el) {
        var txt = [];
